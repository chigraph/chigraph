...
std::pair<chig::DataType, QString> getDataNamePair(QWidget* parent, chig::JsonModule* mod) {
    ...
    auto qualtype = QInputDialog::getItem(parent, i18n("Select Type"), i18n("Type"), createTypeOptions(mod));
    ...
    if(!res) {
        KMessageBox::detailedError(parent, "Failed to get data type", QString::fromStdString(res.dump()), "Failure!");
        return {};
    }
