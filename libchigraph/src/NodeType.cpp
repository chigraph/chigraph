...
void NodeType::setDataInputs(std::vector< chi::NamedDataType, std::allocator< chi::NamedDataType > > newInputs){ mDataInputs = std::move(newInputs); }

void NodeType::setDataOutputs(std::vector< chi::NamedDataType, std::allocator< chi::NamedDataType > > newOutputs){
	mDataOutputs = std::move(newOutputs);
}

void NodeType::setExecInputs(std::vector<std::string> newInputs){ mExecInputs = std::move(newInputs); }
