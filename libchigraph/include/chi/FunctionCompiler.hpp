...
struct FunctionCompiler {
	...
	llvm::DISubprogram& diFunction() const { assert(initialized() && "Please initialize the function compiler before getting the debug function"); return *mDebugFunc; }
	...
	llvm::BasicBlock& allocBlock() const { assert(initialized() && "Please initialize the function compiler before getting the alloc block"); return *mAllocBlock; }
