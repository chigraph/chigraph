...
CFuncNode::CFuncNode(chig::Context& con, const std::string& Ccode, const std::string& functocall) : NodeType{con}
{
	module = "c";
	name = "func";
	...
	llfunc = llcompiledmod->getFunction(functocall);
...
Result CFuncNode::codegen(size_t, llvm::Function* f, const std::vector<llvm::Value *>& io, llvm::BasicBlock* codegenInto, const std::vector<llvm::BasicBlock *>& outputBlocks) const
{
