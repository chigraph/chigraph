...
#endif
#if !(defined vfprintf && defined _GL_STDIO_H || defined __MINGW32__) /* don't override gnulib */
#undef vfprintf
#define vfprintf libintl_vfprintf
extern int vfprintf (FILE *, const char *, va_list);
#endif

#if !(defined printf && defined _GL_STDIO_H || defined __MINGW32__) /* don't override gnulib */
#undef printf
