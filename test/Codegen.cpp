...
TEST_CASE("Code can be generated", "[GraphFunction]") {
	...
	auto ret1Node = func.insertNode(c.getNodeType("lang", "exit", nlohmann::json::parse("{\"Hello\": \"lang:i32\"}")), 23.f, 234.f);
	auto ret2Node = func.insertNode(c.getNodeType("lang", "exit", nlohmann::json::parse("{\"Hello\": \"lang:i32\"}")), 23.f, 234.f);
